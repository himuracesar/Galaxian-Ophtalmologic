...
#define X_SPACE_ENEMIES 20 //Espacio en X entre los enemigos de la tropa
#define Y_SPACE_ENEMIES 10 //Espacio en Y entre los enemigos de la tropa
#define WIDTH_MARGIN 150
#define HEIGHT_MARGIN 60
#define SPACE_PLAYER_AND_TROOP 200
#define WIDTH_ENEMY 109
#define HEIGHT_ENEMY 98
...
#define TROOPS 2
#define ATTACK 4 //Tiempo en segundos para que un enemigo ataque
#define POINTS_KILL 7
//States
...
class Nivel2 : public DogBaseApp
{
	public:
		Nivel2();
		virtual ~Nivel2();
