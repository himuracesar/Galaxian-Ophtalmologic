...
#define X_SPACE_ENEMIES 15 //Espacio en X entre los enemigos de la tropa
...
#define WIDTH_ENEMY 46
#define HEIGHT_ENEMY 39
...
#define TROOPS 2
#define ATTACK 2 //Tiempo en segundos para que un enemigo ataque
#define POINTS_KILL 14
//States
...
class Nivel5 : public DogBaseApp
{
	public:
		Nivel5();
		virtual ~Nivel5();
