...
#define X_SPACE_ENEMIES 10 //Espacio en X entre los enemigos de la tropa
#define Y_SPACE_ENEMIES 3 //Espacio en Y entre los enemigos de la tropa
#define WIDTH_MARGIN 150
#define HEIGHT_MARGIN 60
#define SPACE_PLAYER_AND_TROOP 200
#define WIDTH_ENEMY 95
#define HEIGHT_ENEMY 79
...
class Nivel4 : public DogBaseApp
{
	public:
		Nivel4();
		virtual ~Nivel4();
